...
input_path = "file:///C:/Users/huuhu/Desktop/spark/graph.txt"
...
# === 6. Vòng lặp Personalized PageRank ===
start_time = time.time()

for i in range(num_iterations):
    print(f"\n Iteration {i + 1}")

    # Lưu ranks hiện tại cho vòng sau
    ...
    # In tạm giá trị mỗi vòng (tuỳ chọn)
...
print(f"\n Personalized PageRank after {num_iterations} iterations (normalized):")
